...
public class RedisServiceImpl implements RedisService<String, Object> {
    ...
    //=======================================================================
    @Override
    public void hadd(String key,String sessionId, byte[] bytes){
        redisTemplate.boundHashOps(key).put(sessionId, bytes);
    }
    @Override
    public void hadd(String key,String sessionId, Object session){
        redisTemplate.boundHashOps(key).put(sessionId, session);
    }

    @Override
    public void hdelete(String key,String sessionId){
        redisTemplate.boundHashOps(key).delete(sessionId);
    }

    @Override
    public Object hget(String key,String sessionId){
        return redisTemplate.boundHashOps(key).get(sessionId);
    }
