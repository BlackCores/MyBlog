...
public interface RedisService<K,V> {
     ...
     * @param bytes
     */
    void hadd(String key,String sessionId, byte[] bytes);
     ...
     * @param session
     */
    void hadd(String key,String sessionId, Object session);

    /**
     * 根据key删除
     * @param sessionId
     */
    void hdelete(String key,String sessionId);
     ...
     * @return
     */
    Object hget(String key,String sessionId);
